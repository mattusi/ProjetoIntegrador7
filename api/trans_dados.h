...
void atualiza_Status_Rota() {
    ...
    if(WiFi.status()== WL_CONNECTED){
     ...
     http.begin(host+"/atualiza_status_rota.php?prota_id="+prota_id+"&prota_st="+prota_st+"&api_key="+apiKeyValue+""); // http://becsenac.life/api/atualiza_status_rota.php?prota_id=1&prota_st=2&api_key=tPmAT5Ab3j7F9
...
void atualiza_Status_Veiculo() {
    ...
    if(WiFi.status()== WL_CONNECTED){
     ...
     http.begin(host+"/atualiza_status_veiculo.php?veic_id="+veic_id+"&veic_pt="+veic_pt+"&veic_st="+veic_st+"&api_key="+apiKeyValue+""); // http://becsenac.life/api/atualiza_status_veiculo.php?veic_id=1&veic_pt=2&veic_st=1&api_key=tPmAT5Ab3j7F9
